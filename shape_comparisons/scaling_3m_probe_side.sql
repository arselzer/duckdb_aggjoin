...
-- Scaling: 3M keys (hash mode), probe-side shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_3m_probe_side.sql

.print === Scaling: 3M keys (hash mode) (probe-side shape only) ===
.timer on
