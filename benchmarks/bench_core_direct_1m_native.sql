...
-- 2. Direct mode: 1M keys, 10M rows (uniform), native side only
-- Run: build/Release/duckdb < benchmarks/bench_core_direct_1m_native.sql

.print === Direct mode: 1M keys, 10M rows, uniform (Native only) ===
.timer on
