...
-- 4. Zipf-skewed distribution: 100K keys, 10M rows, native side only
-- Run: build/Release/duckdb < benchmarks/bench_core_zipf_100k_native.sql

.print === Zipf-skewed: 100K keys, 10M rows (Native only) ===
.timer on
