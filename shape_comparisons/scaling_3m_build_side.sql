...
-- Scaling: 3M keys (hash mode), build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_3m_build_side.sql

.print === Scaling: 3M keys (hash mode) (build-side comparison shape only) ===
.timer on
