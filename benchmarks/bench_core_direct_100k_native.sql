...
-- 1. Direct mode: 100K keys, 10M rows (uniform), native side only
-- Run: build/Release/duckdb < benchmarks/bench_core_direct_100k_native.sql

.print === Direct mode: 100K keys, 10M rows, uniform (Native only) ===
.timer on
