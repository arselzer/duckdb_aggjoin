...
-- Scaling: 10K keys, build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_10k_build_side.sql

.print === Scaling: 10K keys (build-side comparison shape only) ===
.timer on
