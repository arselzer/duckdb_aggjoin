...
-- Scaling: 5M keys (deep hash mode), AGGJOIN side only
-- Run: build/Release/duckdb < benchmarks/bench_scaling_5m_aggjoin.sql

.print === Scaling: 5M keys (deep hash mode) (AGGJOIN only) ===
.timer on
