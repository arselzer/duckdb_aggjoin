...
-- Scaling: 10K keys, probe-side shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_10k_probe_side.sql

.print === Scaling: 10K keys (probe-side shape only) ===
.timer on
