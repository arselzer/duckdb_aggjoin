-- AggJoin comprehensive benchmark suite
-- Tests direct mode, hash mode, various distributions
-- Run: build/Release/duckdb < benchmarks/bench.sql

.print ============================================================
.print  AggJoin Comprehensive Benchmark Suite
...
.print  Native baseline uses build-side GROUP BY (optimizer bails).
