...
-- Scaling: 500K keys, probe-side shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_500k_probe_side.sql

.print === Scaling: 500K keys (probe-side shape only) ===
.timer on
