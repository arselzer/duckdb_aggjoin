...
-- Scaling: 5M keys (deep hash mode), probe-side shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_5m_probe_side.sql

.print === Scaling: 5M keys (deep hash mode) (probe-side shape only) ===
.timer on
