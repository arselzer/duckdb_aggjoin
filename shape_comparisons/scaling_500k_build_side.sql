...
-- Scaling: 500K keys, build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_500k_build_side.sql

.print === Scaling: 500K keys (build-side comparison shape only) ===
.timer on
