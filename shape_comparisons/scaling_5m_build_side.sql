...
-- Scaling: 5M keys (deep hash mode), build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_5m_build_side.sql

.print === Scaling: 5M keys (deep hash mode) (build-side comparison shape only) ===
.timer on
