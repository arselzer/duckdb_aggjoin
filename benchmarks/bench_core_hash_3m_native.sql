...
-- 3. Hash mode: 3M keys, 10M rows, native side only
-- Run: build/Release/duckdb < benchmarks/bench_core_hash_3m_native.sql

.print === Hash mode: 3M keys, 10M rows, uniform (Native only) ===
.timer on
