...
-- Scaling: 1M keys, build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_1m_build_side.sql

.print === Scaling: 1M keys (build-side comparison shape only) ===
.timer on
