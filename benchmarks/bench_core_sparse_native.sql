...
-- 5. Sparse keys: 100K rows over a 10M range, native side only
-- Run: build/Release/duckdb < benchmarks/bench_core_sparse_native.sql

.print === Sparse: ~100K keys, range 10M, 100K rows (Native only) ===
.timer on
