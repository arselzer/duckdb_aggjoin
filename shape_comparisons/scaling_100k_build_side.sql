...
-- Scaling: 100K keys, build-side comparison shape only
-- Run: build/Release/duckdb < shape_comparisons/scaling_100k_build_side.sql

.print === Scaling: 100K keys (build-side comparison shape only) ===
.timer on
